...
tar -xvf /opt/android-sdk-linux/system-images/android-26/google_apis/x86/userdata.img.tar.gz --directory /
tar -xvf /opt/android-sdk-linux/system-images/android-26/google_apis/x86/system.img.tar.gz --directory /
